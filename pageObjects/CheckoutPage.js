...
class CheckoutPage {
    ...
    async fillCreditCardDetails(cardNumber, monthValue, DateValue, cvvNumber) {
    ...
    async fillNameAndCouponCode(nameOnCard, couponCode) {
    ...
    async validateEmailAndFillCountry(email, countryName) {
